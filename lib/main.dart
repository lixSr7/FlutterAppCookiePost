...
class MyLineChart extends StatelessWidget {
  final List<LineSeries<MyRowData, dynamic>> seriesList;
  final bool animate;

  const MyLineChart(this.seriesList, {this.animate = false});

  @override
  Widget build(BuildContext context) {
    return SfCartesianChart(
      primaryXAxis: const CategoryAxis(),
      primaryYAxis: const NumericAxis(interval: 10),
      series: seriesList,
    );
  }
}
                          ...
                          child: Padding(
                            ...
                            child: Column(
                              ...
                              children: [
                                Container(
                                  height: 150,
                                  child: DisabledPostsPieChart(snapshot.data!),
                                ),
                                Row(
                          ...
                          child: Padding(
                            ...
                            child: Column(
                              ...
                              children: [
                                Container(
                                  height: 150,
                                  child: MyLineChart(seriesListLine),
                                ),
                                const Text(
                                ...
                                const Padding(
                                  ...
                                  child: Text(
                                    'Basado en el gráfico, podemos observar que el número de publicaciones tiende a aumentar durante la semana y disminuir durante el fin de semana. Esto sugiere que los usuarios son más activos en la plataforma durante los días laborables.',
                                    style: TextStyle(fontSize: 12),
                                  ),
                                ),
                              ],
